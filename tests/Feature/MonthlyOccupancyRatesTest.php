...
{
    public function test_get_monthly_occupancy_for_all_rooms(): void
    {
        ...
        $response = $this->json('GET', '/api/booking/monthly-occupancy-rates/2022-01');
    ...
    public function test_get_daily_occupancy_for_rooms_b_and_c(): void
    {
        ...
        $response = $this->json('GET',
            '/api/booking/monthly-occupancy-rates/2022-01?rooms[]=' . $this->roomB->id . '&rooms[]=' . $this->roomC->id
        );
