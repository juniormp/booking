...
class MonthlyOccupancyRatesRequestTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->rules = (new MonthlyOccupancyRatesRequest())->rules();
    }
    ...
    public function test_room_id_validation_rule()
    {
        ...
        $this->assertTrue($this->validateField('date', '2022-02'));
        $this->assertFalse($this->validateField('date', '2022-02-01'));
